...
namespace RealEstateManagement.Data.Migrations
{
    ...
    [Migration("20250731054405_Add_Slider")]
            ...
            modelBuilder.Entity("RealEstateManagement.Data.Entity.Payment.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Balance = 0m,
                            CreatedAt = new DateTime(2025, 7, 31, 5, 44, 1, 697, DateTimeKind.Utc).AddTicks(9583),
                            UserId = 2
                        });
                });
            ...
            modelBuilder.Entity("RealEstateManagement.Data.Entity.Payment.WalletTransaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 100000m,
                            CreatedAt = new DateTime(2025, 7, 31, 5, 44, 1, 697, DateTimeKind.Utc).AddTicks(9668),
                            Description = "Nạp thử",
                            Type = "Deposit",
                            WalletId = 1
                        });
